...
class GrpcServer extends UnaryGrpc.UnaryImplBase{

    private String returnFlow = "";
    @Override
    public void getServerResponse(SendData.Message request, StreamObserver<SendData.MessageResponse> responseObserver) {
        SendData.MessageResponse message = SendData.MessageResponse.newBuilder().setMessage("working").build();
...
//            return;
//        }
        pcapPath = "/flowmeter/capture.pcap";
...
//        }
    ...
    static class FlowListener implements FlowGenListener {
        ...
        public static final Logger logger = LoggerFactory.getLogger(FlowListener.class);

        private String fileName;

        private String outPath;
        private List<String> returnFlow = new ArrayList<>();
...
public class Cmd extends UnaryGrpc.UnaryImplBase {
